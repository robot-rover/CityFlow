...
PYBIND11_MODULE(cityflow, m) {
    py::class_<CityFlow::Engine>(m, "Engine")
        ...
        .def("get_total_travel_time", &CityFlow::Engine::getTotalTravelTime)
        .def("get_average_waiting_time", &CityFlow::Engine::getAverageWaitingTime)
        .def("get_total_waiting_time", &CityFlow::Engine::getTotalWaitingTime)
